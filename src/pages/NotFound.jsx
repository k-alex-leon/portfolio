  ...
  return (
    <div className="flex flex-col w-full h-full bg-slate-400 items-center justify-center rounded-[90px]">
      <div className="flex flex-col w-full max-w-md text-center items-center">
        ...
        <Link
          to="/"
          className="inline-flex items-center justify-center rounded-md bg-primary px-4 py-2 text-3xl font-medium text-primary-foreground shadow transition-colors hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
        >
